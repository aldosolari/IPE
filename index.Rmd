...
1. [Descriptive Statistics](docs/intro/1_descriptive.pdf)
2. [Probability and Random Variables](docs/intro/2_probability.pdf)
3. [Statistical Inference](docs/intro/3_inference.pdf)
